...
- Memory is `.claude/agent-memory/mobile-kit-test-<name>/`. The `##` heading must be unused. The name must not collide with an agent in this kit, another plugin, or a built-in.
